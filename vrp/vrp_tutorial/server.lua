...
function tutorial.event:test()
	--[[
			Code goes here
	--]]
	self.remote._test(source)			-- this will call tunnel function client side	
end
--################################################
--              Tunnel                 
--################################################
function tutorial.tunnel:startTest()			--this is what the client side will call
	vRP:triggerEvent("test", source)			-- this will call the event function tutorial.event:test()
end
